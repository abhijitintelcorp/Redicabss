...
$query="UPDATE tblvehicles SET Vimage4='$vimage' where id='$id'";
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" name="changingimg4" id="changingimg4" enctype="multipart/form-data">
...
<?php 
$id=intval($_GET['imgid']);
$query1 ="SELECT Vimage4 from tblvehicles where tblvehicles.id='$id'";
