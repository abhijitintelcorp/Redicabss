			...
			<div class="succWrap"><strong>SUCCESS</strong></div> -->
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_name" class="col-sm-4 control-label">Owner Name
                                                        <span style="color:red">*</span></label>

                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="owner_name"
                                                            id="owner_name" placeholder="Enter  Name" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_mobile" class="col-sm-4 control-label">Mobile
                                                        <span style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="number" class="form-control" name="owner_mobile"
                                                            id="owner_mobile" placeholder="Mobile Number" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_email" class="col-sm-4 control-label"> Email Id
                                                        <span style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="email" class="form-control" name="owner_email"
                                                            id="owner_email" placeholder="Email Id" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_vehicle_no" class="col-sm-4 control-label">
                                                        Vehicle Number<span style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="owner_vehicle_no"
                                                            id="owner_vehicle_no" placeholder=" Vehicle Number"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_vehicle_rc_no"
                                                        class="col-sm-4 control-label">Vehicle RC Number <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_rc_no" id="owner_vehicle_rc_no"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_vehicle_jcc_no"
                                                        class="col-sm-4 control-label">Vehicle Jcc Number <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_jcc_no" id="owner_vehicle_jcc_no"
                                                            placeholder=" Vehicle Jcc Number" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_vehicle_brand"
                                                        class="col-sm-4 control-label">Vehicle Brand <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_brand" id="owner_vehicle_brand"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_vehicle_name" class="col-sm-4 control-label">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="owner_vehicle_color" class="col-sm-4 control-label">
                                                        Vehicle Color <span style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_color" id="owner_vehicle_color"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"> Assign Driver <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    Front Image <span style="color:red">*</span><input type="file"
                                                        name="front_image" id="front_image" required>
                                                </div>
                                                <div class="col-sm-4">
                                                    Back Image <span style="color:red">*</span><input type="file"
                                                        name="back_image" id="back_image" required>
                                                </div>
                                                <div class="col-sm-4">
                                                    Side Image <span style="color:red">*</span><input type="file"
                                                        name="side_image" id="side_image" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    Adhar Front Image <span style="color:red">*</span><input type="file"
                                                        name="adhar_front" id="adhar_front" required>
                                                </div>
                                                <div class="col-sm-4">
                                                    Adhar Back Image <span style="color:red">*</span><input type="file"
                                                        name="adhar_back" id="adhar_back" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                    ...
                                                    <button class="btn btn-primary" name="owner_submit"
