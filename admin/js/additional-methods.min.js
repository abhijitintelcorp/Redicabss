    ...
    return (
        ...
        a.validator.addMethod(
            ...
            function(b, c, d) {
                ...
                if (
                    ...
                    for (
                        g = new RegExp(".?(" + h + ")$", "i"), e = 0; e < c.files.length; e++
                    )
        ...
        a.validator.addMethod(
            ...
            function(a, b) {
                ...
                if (
                    ...
                    return !1;
                for (
                    d = l.substring(4, l.length) + l.substring(0, 4), j = 0; j < d.length; j++
                )
                    (e = d.charAt(j)),
                    "0" !== e && (n = !1),
        ...
        a.validator.addMethod(
            ...
            function(a) {
                ...
                return (
                    (a = a.toString().toUpperCase()), !(a.length > 10 || a.length < 9 || !c.test(a)) &&
                    ((a = a
                            .replace(/^[X]/, "0")
                            .replace(/^[Y]/, "1")
                            .replace(/^[Z]/, "2")),
