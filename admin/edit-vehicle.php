                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="ownname" class="form-control"
                                                        value="<?php echo htmlentities($result->ownname)?>" required>
                                                </div>
                                                <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" name="vehno" class="form-control"
                                                                    value="<?php echo htmlentities($result->vehno)?>"
                                                                    required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label">VehicleRegNo<span
                                                                        style="color:red">*</span></label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="vehreg"
                                                                        class="form-control"
                                                                        value="<?php echo htmlentities($result->vehreg)?>"
                                                                        required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-sm-2 control-label">VehicleTitle<span
                                                                            style="color:red">*</span></label>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="VehiclesTitle"
                                                                            class="form-control"
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <select class="selectpicker" name="brandname"
                                                                            required>
                                                                            <option
                                                                                value="<?php echo htmlentities($result->bid);?>">
...
?>
                                                                            <option
                                                                                value="<?php echo htmlentities($results->id);?>">
...
{?>
                                                                        <div class="checkbox checkbox-inline">
                                                                            ...
                                                                            <label for="inlineCheckbox2"> Power Door
                                                                                Locks </label>
                                                                        </div>
                                                                        <?php } else {?>
                                                                        <div
...
{?>
                                                                        <div class="checkbox checkbox-inline">
                                                                            <input type="checkbox" id="inlineCheckbox1"
                                                                                ...
                                                                                value="1">
                                                                            <label for="inlineCheckbox3"> AntiLock
                                                                        ...
                                                                        <?php if($result->BrakeAssist==1)
{
	?>
                                                                        <div class="checkbox checkbox-inline">
                                                                            <input type="checkbox" id="inlineCheckbox1"
                                                                                name="brakeassist" checked value="1">
                                                                            <label for="inlineCheckbox3"> Brake Assist
                                                                            </label>
                                                                        </div>
                                                                        <?php } else {?>
                                                                        <div class="checkbox checkbox-inline">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="checkbox checkbox-inline">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1">
                                                                                <label for="inlineCheckbox1"> Power
                                                                                    Steering </label>
                                                                            </div>
                                                                            <?php } else {?>
                                                                            <div class="col-sm-3">
...
?>
                                                                                <div class="checkbox checkbox-inline">
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        value="1">
                                                                                    <label for="inlineCheckbox2">Driver
                                                                                        Airbag</label>
                                                                                </div>
                                                                                <?php } else { ?>
                                                                                <div class="checkbox checkbox-inline">
