...
<head>
	...
	<title>Redicabs | Admin Dashboard</title>
...
?>
											...
											<a href="reg-users.php" class="block-anchor panel-footer" style="color: #080807">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default" style="border: 2px solid;border-color: black">
...
?>
											...
											<a href="manage-vehicles.php" class="block-anchor panel-footer text-center" style="color: #080807">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default"style="border: 2px solid;border-color: black">
...
?>
											...
											<a href="manage-bookings.php" class="block-anchor panel-footer text-center" style="color: #080807">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default"style="border: 2px solid;border-color: black">
...
?>												
											...
											<a href="manage-brands.php" class="block-anchor panel-footer text-center" style="color: #080807">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
