...
$query="UPDATE tblvehicles SET Vimage2='$vimage' where id='$id'";
...
<?php 
$id=intval($_GET['imgid']);
$query1 ="SELECT Vimage2 from tblvehicles where tblvehicles.id='$id'";
...
<div class="col-sm-8">
<img src="img/vehicleimages/<?php echo $row['Vimage2'];?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
