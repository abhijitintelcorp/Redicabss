    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
			...
			<div class="succWrap"><strong>SUCCESS</strong></div> -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="owner_name"
                                                            id="owner_name" value="<?php echo $urows['owner_name']; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"> Email Id <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"> Vehicle Number <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Vehicle RC Number <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_rc_no" id="owner_vehicle_rc_no"
                                                            value="<?php echo $urows['owner_vehicle_rc_no']; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Vehicle Jcc Number <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_jcc_no" id="owner_vehicle_jcc_no"
                                                            value="<?php echo $urows['owner_vehicle_jcc_no']; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Vehicle Brand <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"> Vehicle Color <span
                                                            style="color:red">*</span></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                            name="owner_vehicle_color" id="owner_vehicle_color"
                                                            value="<?php echo $urows['owner_vehicle_color']; ?>">
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    Front Image
                                                    <img src="image/<?php echo $urows['front_image']; ?>"
                                                        style="width:20%;">
                                                ...
                                                <div class="col-sm-4">
                                                    Back Image
                                                    <img src="image/<?php echo $urows['back_image']; ?>"
                                                        style="width:20%;">
                                                    <span style="color:red">*</span><input type="file" name="back_image"
                                                        id="back_image" required>
                                                </div>
                                                <div class="col-sm-4">
                                                    Side Image
                                                    <img src="image/<?php echo $urows['side_image']; ?>"
                                                        style="width:20%;">
                                                    <span style="color:red">*</span><input type="file" name="side_image"
                                                        id="side_image" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    Adhar Front Image
                                                    <img src="image/<?php echo $urows['adhar_front']; ?>"
                                                        style="width:20%;">
                                                    <span style="color:red">*</span><input type="file"
                                                ...
                                                <div class="col-sm-4">
                                                    Adhar Back Image
                                                    <img src="image/<?php echo $urows['adhar_back']; ?>"
                                                        style="width:20%;">
                                                    <span style="color:red">*</span><input type="file" name="adhar_back"
                                                        id="adhar_back" required>
                                                </div>
